```bash
docker run -d --name gitlab-runner3 --restart always -v /var/run/docker.sock:/var/run/docker.sock --network=gitlab  -v $pwd/gitlab-runner3:/etc/gitlab-runner   gitlab/gitlab-runner:latest
