    ...
    /******/ [
      ...
      /***/ function (module, exports) {
        ...
        exports.looseEqual = function (a, b) {
          ...
          return (
            a == b || (exports.isObject(a) && exports.isObject(b) ? JSON.stringify(a) === JSON.stringify(b) : false)
          )
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        strats.paramAttributes = function () {
          ...
          'development' !== 'production' &&
            _.warn('"paramAttributes" option has been deprecated in 0.12. ' + 'Use "props" instead.')
        }
          ...
          if (options.components) {
            ...
            for (var i = 0, l = ids.length; i < l; i++) {
              ...
              if (_.commonTagRE.test(key)) {
                'development' !== 'production' &&
                  _.warn('Do not use built-in HTML elements as component ' + 'id: ' + key)
                continue
              }
              def = components[key]
        ...
        function guardArrayAssets(assets) {
          if (_.isArray(assets)) {
            ...
            while (i--) {
              ...
              if (!id) {
                'development' !== 'production' && _.warn('Array-syntax assets must provide an id field.')
              } else {
                res[id] = asset
              }
            }
        ...
        exports.assertProp = function (prop, value) {
          ...
          if (validator) {
            if (!validator.call(null, value)) {
              'development' !== 'production' &&
                _.warn('Invalid prop: custom validator check failed for ' + prop.path + '="' + prop.raw + '"')
              return false
            }
          }
          return true
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.compile = function (el, options, partial) {
          ...
          var childLinkFn =
            !(nodeLinkFn && nodeLinkFn.terminal) && el.tagName !== 'SCRIPT' && el.hasChildNodes()
        ...
        function compileNodeList(nodeList, options) {
          ...
          for (var i = 0, l = nodeList.length; i < l; i++) {
            ...
            childLinkFn =
              !(nodeLinkFn && nodeLinkFn.terminal) && node.tagName !== 'SCRIPT' && node.hasChildNodes()
        ...
        module.exports = function compileProps(el, propOptions) {
          ...
          while (i--) {
            ...
            if (!identRE.test(path)) {
              'development' !== 'production' &&
                _.warn('Invalid prop key: "' + name + '". Prop keys ' + 'must be valid identifiers.')
              continue
            }
              ...
              if (tokens) {
                ...
                if (literal || (single && tokens[0].oneTime)) {
                  ...
                  if (settablePathRE.test(prop.parentPath)) {
                    ...
                    'development' !== 'production' &&
                      _.warn('Cannot bind two-way prop with non-settable ' + 'parent path: ' + prop.parentPath)
                  }
                }
        ...
        module.exports = {
          ...
          bind: function () {
            if (!this.el.__vue__) {
              ...
              'development' !== 'production' &&
                _.warn('cannot mount component "' + this.expression + '" ' + 'on already mounted element: ' + this.el)
            }
          },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = {
          ...
          bind: function () {
            ...
            if (!vm) {
              'development' !== 'production' && _.warn('v-ref should only be used on a component root element.')
              return
            }
        ...
        function initOptions(expression) {
          ...
          function optionUpdateWatcher(value) {
            if (_.isArray(value)) {
              ...
              'development' !== 'production' && _.warn('Invalid options value for v-model: ' + value)
            }
          }
        ...
        module.exports = {
          ...
          resolveDynamicComponent: function (data, meta) {
            ...
            if (!Component.options) {
              'development' !== 'production' &&
                _.warn(
                  'Async resolution is not supported for v-repeat ' + '+ dynamic component. (component: ' + id + ')'
                )
              return _.Vue
            }
            return Component
          ...
          cacheVm: function (data, vm, index, key) {
            ...
            if (key || idKey || primitive) {
              ...
              if (!cache[id]) {
                ...
                'development' !== 'production' &&
                  _.warn('Duplicate objects with the same track-by key in v-repeat: ' + id)
              }
            } else {
              id = this.id
              if (data.hasOwnProperty(id)) {
                if (data[id] === null) {
                  ...
                  'development' !== 'production' &&
                    _.warn('Duplicate objects found in v-repeat="' + this.expression + '": ' + JSON.stringify(data))
                }
              } else {
                _.define(data, id, vm)
              }
        ...
        module.exports = {
          bind: function () {
            ...
            if (!el.__vue__) {
              ...
              'development' !== 'production' &&
                _.warn('v-if="' + this.expression + '" cannot be ' + 'used on an instance root element.')
              this.invalid = true
            }
          },
        ...
        function register(vm, action, key, handler, options) {
          ...
          if (type === 'function') {
            ...
            if (method) {
              ...
              'development' !== 'production' &&
                _.warn(
                  'Unknown method: "' + handler + '" when ' + 'registering callback for ' + action + ': "' + key + '".'
                )
            }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports._initProps = function () {
          ...
          if (props && !el) {
            'development' !== 'production' &&
              _.warn('Props will not be compiled if no `el` option is ' + 'provided at instantiation.')
          }
            ...
            if (factory.resolved) {
              ...
              factory(
                ...
                function reject(reason) {
                  'development' !== 'production' &&
                    _.warn('Failed to resolve async component: ' + id + '. ' + (reason ? '\nReason: ' + reason : ''))
                }
              )
            }
          } else {
