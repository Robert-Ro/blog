...
declare namespace webpack {
  ...
  namespace compilation {
    ...
    class Chunk {
      ...
      modulesSize(): number
      size(options?: { chunkOverhead?: number | undefined; entryChunkMultiplicator?: number | undefined }): number
  ...
  namespace DefinePlugin {
    class RuntimeValue {
      constructor(fn: ({ module }: { module: compilation.Module }) => CodeValuePrimitive, fileDependencies?: string[])
